...
from app.observers.master.SMARTS_rxn_generator.prompt import (
    QUERY,
    INSTRUCTIONS,
    RETRY_QUERY
)
...
async def run_agent(
    ...
    **kwargs
    ...
    model_identity="YOU ARE AN EXPERT AGENT THAT GENERATES SMARTS NOTATION FOR CHEMICAL REACTION TEXTS"
    ...
    params = {
        ...
        "master_query": QUERY,
        "output_schema": RXNSMARTSOutputSchema, 
        "model_identity": model_identity,
        "validator": StringValidator(),
        "validator_key": "SMARTS_reaction_response",
